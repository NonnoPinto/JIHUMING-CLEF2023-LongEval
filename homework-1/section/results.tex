...
\begin{figure}[h!]
	...
	\label{fig:scores}
\end{figure}
It's interesting to notice that a cross-language approach (fr\_en\_fr\_5gram) is one of the best performing indexes, even though it's not the best one. %TODO: how is it possibile that a cross language is better than only english??
