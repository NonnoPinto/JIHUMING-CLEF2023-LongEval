...
The search engine's collections are sourced from the CLEF, which gathered queries from Qwant users
 based on trending topics related to their daily lives. The data collection period was June 2022, 
 and the dataset consists of 672 training queries, 9656 corresponding assignments from the Qwant 
 click model, and 98 heldout queries. The queries are available in both French and English, with 
 the French queries translated using the CUBBITT system. The training queries are categorized into 
 twenty topics, including car-related, antivirus-related, employment-related, energy-related, 
 recipe-related, rental car-related, video-related, war-related, gateau-related, police-related, 
 tax-related, solar panel-related, water-related, elderberry-related, curtain-related, land-related, 
