...
%%
%% The "title" command
\title{SEUPD@CLEF: Team JIHUMING on Enhancing Search Engine Performance on the CLEF LongEval Corpus with Character N-Grams, Query Expansion, and Named Entity Recognition}
...
\begin{abstract}
  ...
  Additionally, we performed a Two-Way ANOVA to assess the AP of the systems.
  % Results
  In summary, our analysis reveals that using French queries improves search results, larger N-gram sizes enhance
  effectiveness, and our NER approach has a detrimental impact on the scores.
\end{abstract}
