...
%%
%% The "title" command
% TODO: <short description> should be substituted by a title (probably)
\title{SEUPD@CLEF: Team JIHUMING on <Short Description>}
...
\begin{abstract}
  ...
  terms of MAP and NDCG scores. %TODO: include new results from HW2 if any
\end{abstract}
