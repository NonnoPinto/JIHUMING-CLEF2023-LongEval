...
\begin{itemize}
	...
	base)scores computed for our systems on the test data (short-term, long-term and held-out), to get a reliable
	estimator of the final performance.
	\item Statistical analysis using Two-Way ANOVA to assess the Average Precision (AP) of the five system submissions
	across all the topics on the test data (short-term, long-term and held-out).
