...
We evaluated the performance of the 12 systems we developed by measuring the effectiveness of runs on the training data, comprising both French and translated English queries and documents. To assess the quality of these runs, we used the MAP and NDCG scores calculated by \texttt{trec\_eval}. Among these systems, five models performed the best, namely \texttt{fr\_fr\_5gram}, \texttt{fr\_fr\_4gram}, \texttt{fr\_fr\_3gram}, \texttt{fr\_fr}, and \texttt{fr\_fr\_4gram\_ner}, listed in order of their scores from highest to lowest for both MAP and NDCG.\\
